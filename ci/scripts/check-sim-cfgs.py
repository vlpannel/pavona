        ...
        if len(sim_cfg_files) == 1:
            ...
            if 'name' not in fields:
                ...
                if 'variant' in fields:
                    ...
                    # generated file: ip_autogen IPs (e.g. flash_ctrl) or xbar
                    # cfgs generated by tlgen under a 'dv/autogen' directory.
                    if 'ip_autogen' not in parts and 'autogen' not in parts:
