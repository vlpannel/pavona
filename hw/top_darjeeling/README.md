...
Large parts of Darjeeling's code is generated based on configuration and template files via key components of the Architectural Composition Engine  (ACE), namely [topgen](../../util/topgen/README.md) and [ipgen](../../util/ipgen/README.md).
